...
import "./MazarStyles/MazarFeedback.css";
  ...
  <Card className="ezy__contact2-form-card animate-on-scroll">
    <Card.Body className="p-md-5">
      ...
      <p className="ezy__contact2-sub-heading mb-5 animate-on-scroll">
        Please provide your feedback here for the mazar mubarak.
      </p>
      <FeedbackForm />
    </Card.Body>
  </Card>
          ...
          <Row className="py-4 justify-content-between">
            <Col lg={6} className="mb-5 mb-lg-0">
              ...
              <p className="ezy__contact2-sub-heading mb-0 text-white animate-on-scroll">
                We are glad that you have chosen Rehlat-Ul-Mumenin for your upcoming journeys and exploring the significance of our holy shrines in India and Foreign countries.
              </p>
            </Col>
            <Col lg={5}>
              <FeedbackFormCard />
