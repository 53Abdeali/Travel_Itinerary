...
function Kapadvanj() {
  ...
  const filteredMazars = mazar.filter((item) => item.city === "Kapadvanj");
        ...
        <div className="mazarat-text">
          {showLisanDawat ? (
            ...
            <>
              ...
              <p className="animate-on-scroll">
                Syedi Khoj bin Malak (Q.R.) was a respected figure in
                Dawat-e-Hadiyah, serving Syedna Dawood Bin Ajabshah (R.A.) and
                Syedna Dawood Bin Qutubshah (R.A.) with sincerity and devotion.
                Despite facing hardships, including imprisonment in Ahmedabad
                and opposition during Sulaiman's rebellion, he remained
                steadfast in his duties.
              </p>

              <p className={!showMore ? "blur-text" : ""}>
                He invited both Syednas to Kapadwanj, where the local community
                dedicated their lives and wealth to serve the Dai.{" "}
                <span className="animate-on-scroll">
                  {" "}
                  A great historian, Syedi Khoj bin Malak compiled Dawat's
                  history and knowledge in various writings. After Hajj, he
                  remarked that no majlis compared to Dawat's majlis, graced by
                  angels and recorded for mumineen.
                </span>
                <br /> <br />
                <span className="animate-on-scroll">
                  Syedi Mohammad Kazi Khan (QR) had serve for Dawat in the era o
                  fboth Syedna Dawood Bin Ajabshah (RA) & Syedna Dawood Bin
                  Qutubshah (RA). He was too disciplined that the aura of
                  sincerity was more than the aura of Kastoori. he becomes the
                  Aamil of kapadvanj by the permission of both Syednas. When the
                  ruler was Muzaffarshah mumenin were facing oo much hardship,
                  howeever Syedi Mohammad Kazi Khan supported mumenin and act as
                  a care taker.
                </span>
              </p>
            </>
        ...
        <div className="mazarat-ways">
          ...
          <ul>
            ...
            <div className="ways animate-on-scroll">
              ...
              <li className="animate-on-scroll">
                Nearest Railway Station <br /> Kapadvanj Junction Railway
                Station
              </li>
            </div>
            <br />
            <div className="ways animate-on-scroll">
              ...
              <li className="animate-on-scroll">35.9 Kms from Balasinor</li>
              <li className="animate-on-scroll">66.5 Kms from Ahmedabad</li>
              <li className="animate-on-scroll">75.8 Kms from Vadodara</li>
              <li className="animate-on-scroll">75.8 Kms from Godhra</li>
            </div>
          </ul>
        </div>
      </div>
      <div className="mazarat-gallery">
        ...
        <div className="mazarat-abt">
          <div className="mazarat-image">
            <h2>Kapadvanj Mazar Gallery</h2>
            {filteredMazars.map((item) => (
              <img
                key={(item.city = "Kapadvanj")}
                src={item.image}
                alt="Mazar"
              />
            ))}
          ...
          <div className="mazarat-all">
            ...
            <div className="maz-urs-date">
              ...
              <div className="ar-para">
                <p>Syedi Khoj Bin Malak (Q.R.)</p>
                <p>6 Shehre-Zilhijjatil-Haram</p>
              </div>
              <div className="ar-para">
                <p>Syedi Mohammad Kazi Khan (Q.R.)</p>
              </div>
            </div>
