    ...
    <div className="main">
      <div className="feature-heading animate-on-scroll">
        ...
        <div className="container animate-on-scroll">
          <div className="para">
            <h2>Overview</h2>
            <p>
              The Rehlat-Ul-Mumenin project is a specialized travel
            ...
            <h2>Purpose</h2>
            <p>
              The primary purpose of the Rehlat-Ul-Mumenin project
      ...
      <div className="question animate-on-scroll">
        ...
        <div className={`Solution ${isVisible ? "rotateDownLeft" : ""}`}>
          ...
          <p>
            The Rehlat-Ul-Mumenin project aims to bridge this gap
